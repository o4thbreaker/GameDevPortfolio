...
namespace GameDevPortfolio.Controllers
{
    public class DevelopersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Bio")] Developer developer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Bio")] Developer developer)
        {
            if (id != developer.Id)
            {
                return NotFound();
