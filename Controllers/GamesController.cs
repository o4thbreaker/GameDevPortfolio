...
namespace GameDevPortfolio.Controllers
{
    ...
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,DeveloperId")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,DeveloperId")] Game game)
        {
            if (id != game.Id)
            {
                return NotFound();
